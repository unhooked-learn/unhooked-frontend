    ...
    <div class="w-full max-w-md">
      ...
      <form class="mt-4" action="#" method="POST">
        ...
        >{{ $t('pages.settings.language') }}</h3>
          <div class="flex flex-col justify-center my-5 bg-white border border-gray-300 rounded shadow-lg">
            <div class="flex w-full h-full">
                <div class="flex items-center justify-center w-1/5 bg-red-500">
                    <font-awesome-icon icon="exclamation-triangle" class="w-5 p-1 text-white md:p-0 fa-3x" />
                </div>
